...
| **Stack** | Microsoft Power Apps + Azure AI Enclave | Microsoft Power Apps + Azure AI Enclave | Full-stack SG-hosted web app + QR (distinct from Power Apps) |
...
- `classroom.html` — **NEW** hub: problem, 2 modules, Power Apps + Azure AI Enclave architecture, 55-tablet hardware, $110k budget table, 12-month timeline, Classroom KPIs, team.
...
- `leadership.html` — **NEW** hub: problem, 3 modules, Power Apps + Azure AI Enclave, 11-laptop hardware, $120k budget, timeline, Leadership KPIs, team.
...
- `sproutspace.html` — **NEW** hub: problem, 3 modules, full-stack SG-hosted web + QR stack, Category A, detailed $150k budget (Software/Eng $108k + Cloud $14.4k + Equipment $15.6k + Training $8k + Evaluation $4k), equipment list, timeline, KPIs, team.
...
- Architecture: Classroom/Leadership keep Azure AI Enclave; SproutSpace is a different full-stack web + QR stack (must not imply Power Apps).
