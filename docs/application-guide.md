...
- Falls under the **Early Childhood Transformation Initiative**
- Focus: Digital transformation, AI-enabled solutions, sector-wide productivity
- Administered by ECDA in partnership with IMDA and SSG

**Related funding streams (for additional/complementary support):**
- Early Childhood Digitalisation Grant (ECDG) — up to 50% co-funding for pre-approved solutions
- Productivity Solutions Grant (PSG) — for eligible SMEs
- Charities Capability Fund ICT Grant — for eligible charities and IPC operators
- Practitioner Inquiry (PI) Grant — for curriculum innovation ($4,000 max)

---

## Phase 1: Pre-Application Preparation (Start Now)

### Step 1: Register for ECDA Notifications
...
Beyond the core project team, recruit advisors who add credibility:
...
1. **Time Audit**: Survey educators on weekly hours spent on documentation
   - Lesson planning
   - Child portfolio updates
   - Assessment reports
   - Parent communication
   - Administrative tasks

2. **QTT Baseline**: If available, collect current QTT assessment scores for each educator
...
4. **Document Current Workflows**: Map existing processes for:
   - How lesson plans are created
   - How child observations are recorded
   - How portfolios are compiled
   - How professional development is tracked

### Step 5: Prepare Core Documents

**A. Project Proposal Document**
Use the README.md as the foundation and adapt for ECDA's format. Key sections:
- Executive Summary (1 page)
- Problem Statement with local evidence
- Proposed Solution (4 modules)
- Technical Architecture
- Implementation Timeline
- Budget Breakdown
- Team Qualifications
- Expected Outcomes with KPIs
...
When the grant call opens:

1. **Read all guidelines carefully** — note evaluation criteria, eligible expenses, reporting requirements
2. **Download the application form** from the ECDA portal
3. **Complete all required fields** — align language with ECDA's priorities:
...
4. **Budget alignment** — ensure your budget:
   ...
   - Includes any required co-payment (the Innovation Grant requires 5% co-pay)
   - Separates capital vs. operating expenses
   - Shows clear value-for-money

5. **Outcome commitments** — ECDA will likely require:
   - Measurable KPIs with clear baselines and targets
   - Willingness to share findings with the sector
   - Interim reporting milestones
   - Final impact report

### Step 8: Submit and Follow Up

1. Submit through ECDA's official channel (likely online portal)
2. Keep copies of all submitted documents
3. Note any reference numbers
4. Be prepared for:
   - Clarification questions from ECDA
   - Panel presentation/interview (if shortlisted)
...
### Step 9: Prepare for Panel Presentation

If shortlisted, you may be invited to present to an ECDA panel:

**Presentation tips:**
- Keep it to 15-20 minutes
- Lead with the problem (using YOUR baseline data)
- Show the prototype demo (use the GitHub Pages site)
- Emphasize educator benefit over technology
...
### Step 10: If Approved — Launch Execution
...
5. **Enhanced partnerships** — show academic validation and industry collaboration

### Use ECDA's Language

Incorporate ECDA-specific terminology throughout:
- "Key Person" (not "primary caregiver")
- "Enabling Environment" (not "learning space")
- "Unique Child" (not "individual learner")
- "Sustained Shared Thinking" (not "extended dialogue")
- "Learning Dispositions" (not "learning attitudes")
- "Pedagogical Documentation" (not "record keeping")

### Differentiate from Existing Solutions

Research the current ECDG pre-approved solutions list to understand what already exists. Position PedaForge as:
- **Not a Preschool Management System (PMS)** — PedaForge complements PMS by adding AI-powered pedagogical intelligence
- **Not a generic LMS** — PedaForge is purpose-built for Singapore's ECE frameworks
- **The coaching gap** — no existing solution offers QTT-aligned AI coaching with multiple modes

### Show Sustainability

ECDA wants to fund innovations that outlast the grant period:
- SaaS subscription model post-sandbox
- Potential path to ECDG pre-approved solution status
- Interest from multiple operators (not just the pilot partner)
- Revenue projections for years 2-3
...
### ECDA Links
- ECDA IDP 2.0: https://www.ecda.gov.sg/operators/early-childhood-transformation-initiative/early-childhood-industry-digital-plan
- ECDA Innovation Grant: https://www.ecda.gov.sg/early-childhood-educators-(ece)/continuing-professional-development/innovation-grant
- ECDA Main Site: https://www.ecda.gov.sg

### Government References
- MSF Committee of Supply 2026: https://www.msf.gov.sg/media-room/article/msf-committee-of-supply-2026--a-singapore-made-for-families--a-good-start-for-every-child
- IMDA Early Childhood IDP: https://www.imda.gov.sg/how-we-can-help/smes-go-digital/industry-digital-plans/early-childhood-idp

### Framework References
- EYDF (Early Years Development Framework) — available from ECDA
- NEL (Nurturing Early Learners) — available from MOE
- ECDA Quality Teaching Tool (QTT) — available from ECDA
- Skills Framework for ECCE — available from SSG/SkillsFuture

### Academic References
- OECD TALIS Starting Strong Report (2024)
- Bowlby, J. (1969). Attachment and Loss
- Vygotsky, L. (1978). Mind in Society
- Roediger, H. & Karpicke, J. (2006). Test-enhanced learning
- Gibbs, G. (1988). Learning by Doing
- Klein, G. (2007). The Power of Intuition (Pre-Mortem Technique)
...
- [ ] Reviewed ECDA's evaluation criteria (when published)
- [ ] Attended ECDA briefing session (when scheduled)
- [ ] Submitted application within deadline
